      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/owner-classes" element={<ProtectedRoute><OwnerClasses /></ProtectedRoute>} />
            <Route path="/owner-classes/:classId" element={<ProtectedRoute><OwnerClassDetail /></ProtectedRoute>} />
